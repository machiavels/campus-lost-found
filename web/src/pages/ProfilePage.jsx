    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex gap-2 border-b">
        <button onClick={() => setTab('items')}
          className={`pb-2 px-1 text-sm font-medium border-b-2 transition-colors ${tab === 'items' ? 'border-primary-600 text-primary-600' : 'border-transparent text-gray-500 hover:text-gray-700'}`}>
          Mes annonces
        </button>
      </div>
      {isLoading ? (
