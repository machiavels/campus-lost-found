...
export default function AuthScreen() {
  ...
  async function handleLogin() {
    ...
    try {
      ...
      setError(e.data?.message || 'Identifiants incorrects ou serveur inaccessible');
  ...
  async function handleRegister() {
    ...
    try {
      ...
      setError(e.data?.message || 'Erreur lors de la création du compte');
    } finally { setLoading(false); }
  }
          ...
          <View style={s.card}>
            ...
            <View style={s.field}>
              ...
              <TextInput style={s.input} value={email} onChangeText={setEmail}
                placeholder="vous@campus.fr" placeholderTextColor={COLORS.faint}
            ...
            >
              {loading
                ...
                : <Text style={s.btnLabel}>{tab === 'login' ? 'Se connecter' : 'Créer un compte'}</Text>
              }
            </TouchableOpacity>
          </View>
        </ScrollView>
